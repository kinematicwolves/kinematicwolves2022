...
public class BlackLightshow extends CommandBase {
  ...
  public BlackLightshow(LightingSubsystem lighting, VisionSubsystem vision, PneumaticSubsystem pneumaticSubsystem) {
