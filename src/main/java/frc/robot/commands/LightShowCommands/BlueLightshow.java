...
public class BlueLightshow extends CommandBase {
  ...
  public BlueLightshow(LightingSubsystem lighting, VisionSubsystem vision, PneumaticSubsystem pneumaticSubsystem) {
  ...
  public void execute() {
   ...
   m_lighting.setBlueTwinkleAnimation();
  }
